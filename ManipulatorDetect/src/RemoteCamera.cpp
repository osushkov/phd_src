...
RemoteCamera::RemoteCamera(std::string camera_address, int port) : 
    camera_address(camera_address), port(port), image_width(0), image_height(0), frame_num(0) {
...
void RemoteCamera::getImage(std::vector<char> &lbuffer, std::vector<char> &rbuffer){
