...
mp <- barplot(height, beside=TRUE, ylim = c(0, 500), ylab="Number of Features Detected", main="Motion Filtering", cex.names=0.8, legend=c("True arm features", "True object features", "False arm features", "False object features"))
