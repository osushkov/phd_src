...
float IKFitnessFunctionObjectPickup::eval(std::vector<float> &params, float iter_fraction){
    ...
    std::vector<Vector3D> rot_mat = Geometry::axisRotationMatrix(full_pose[3], -25.0f*M_PI/180.0f);
    ...
    distance_penalty += 5.0*height_diff;
