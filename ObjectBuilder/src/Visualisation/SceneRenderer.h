...
class SceneRenderer {
  public:
    ...
    std::pair<IplImage*,IplImage*> renderObject(RenderObject *obj, Transform transform);
  ...
  private:
    ...
    IplImage* renderCamera(Vector3D camera_pos, RenderObject *obj, Transform transform);
