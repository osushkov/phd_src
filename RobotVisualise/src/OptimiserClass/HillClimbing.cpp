...
std::vector<float> HillClimbing::genRandomOffset(std::vector<float> &dimension_magnitude){
...
std::vector<float> HillClimbing::addVectors(std::vector<float> &vec1, std::vector<float> &vec2){
