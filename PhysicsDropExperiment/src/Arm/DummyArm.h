...
class DummyArm : public Arm {
  public:
    ...
    bool closeHandDistance(float cm, int speed=-1){ return true; }
    bool softCloseHand(float initial_amount=0.0f){ return true; }
    bool closeHand(float amount=1.0f, int speed=-1){ return true; }
    bool openHand(float amount=1.0f, int speed=-1){ return true; }
    bool releaseHand(int speed=-1){ return true; }
