...
class Arm {
  public:
    ...
    virtual bool closeHandDistance(float cm, int speed=-1) = 0;
    virtual bool softCloseHand(float initial_amount=0.0f) = 0;
    virtual bool closeHand(float amount=1.0f, int speed=-1) = 0;
    virtual bool openHand(float amount=1.0f, int speed=-1) = 0;
    virtual bool releaseHand(int speed=-1) = 0;
